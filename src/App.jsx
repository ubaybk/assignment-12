...
const caseStudies = [
  {
    ...
    carousel : [
      {
        konten1: "For a local restaurant, we implemented a targeted PPC campaign that resulted in a 50% increase in website traffic and a 25% increase in sales.",
        color: "bg-black",
      }, 
      {
        konten1: "For a B2B software company, we developed an SEO strategy that resulted in a first page ranking for key keywords and a 200% increase in organic traffic.",
        color: "bg-black"
      },
      {
        konten1: "For a national retail chain, we created a social media marketing campaign that increased followers by 25% and generated a 20% increase in online sales.",
        color: "bg-black"
      }
    ]
  }
...
function App() {
  ...
  return (
    <>
    <div className="px-8 flex flex-col gap-10" style={{ scrollBehavior: 'smooth' }}>
      <Navbar />
      <HeroSection propsHeroSection={heroSection} />
      <LabelRuning propsRunning={runningLogo} />
      <section id="services">
      <Services  propsServices={services} propsTitleServices={titleServices} /> </section>
